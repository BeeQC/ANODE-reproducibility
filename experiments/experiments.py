...
from experiments.dataloaders import ConcentricSphere, ShiftedSines, Data1D
    ...
    for dataset in datasets:
        if dataset["type"] == "sphere":
            ...
            data_object = ShiftedSines(data_dim,
                                       ...
                                       dataset["noise_scale"])
        elif dataset["type"] == "1D":
            data_object = Data1D(dataset["target_flip"],
                                 dataset["num_points"],
                                 dataset["noise_scale"])
        ...
        for i, model_config in enumerate(model_configs):
            ...
            for j in range(num_reps):
                ...
                epoch_accuracy_histories.append(trainer.histories["epoch_accuracy_history"])
                if is_ode:
            ...
            results[-1]["model_info"].append({
                ...
                "epoch_accuracy_history": epoch_accuracy_histories,
